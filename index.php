...
<html>
	<head>
		...
		<title><?php echo PAGE_TITLE ?> v1.6.3</title>
	...
	<body onunload="setCookie()">
		...
		<div id="loading">
			...
			<link rel="stylesheet" type="text/css" href="resources/css/icon.css?v1.6.3" />
			...
			<link rel="stylesheet" type="text/css" href="resources/css/public.css?v1.6.3" />
			<link rel="stylesheet" type="text/css" href="resources/css/iconmarker.css?v1.6.3" />
			...
			<script type="text/javascript" src="lib/js/translation_fr.js?v1.6.3"></script>
            <script type="text/javascript" src="lib/js/key.js.template?v1.6.3"></script>
            <script type="text/javascript" src="lib/js/key.js?v1.6.3"></script>
			
			<script type="text/javascript">document.getElementById('loading-msg').innerHTML = 'Loading extensions...';</script>
			<script type="text/javascript" src="lib/js/framework/ux/GeoNamesSearchCombo.js?v1.6.3"></script>
            <script type="text/javascript" src="lib/js/public/poidisplaystatus.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/public/baselayerlist.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/framework/ux/FileUploadField.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/framework/ux/IconCombo.js?v1.6.3"></script>
			...
			<script type="text/javascript" src="lib/js/framework/AnimatedCluster.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/common.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/public/proposition.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/public/export.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/public/map.js?v1.6.3"></script>
			<script type="text/javascript" src="lib/js/public/main.js?v1.6.3"></script>
