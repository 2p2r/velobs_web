...
<html>
	...
	<body onunload="setCookie()">
		...
		<div id="loading">
			...
			<link rel="stylesheet" type="text/css" href="resources/css/public.css?v1.6" />
			...
			<script type="text/javascript" src="lib/js/translation_fr.js?v1.6"></script>
			...
			<script type="text/javascript" src="lib/js/public/baselayerlist.js?v1.6"></script>
			...
			<script type="text/javascript" src="lib/js/public/proposition.js?v1.6"></script>
			<script type="text/javascript" src="lib/js/public/map.js?v1.6"></script>
			<script type="text/javascript" src="lib/js/public/main.js?v1.6"></script>
