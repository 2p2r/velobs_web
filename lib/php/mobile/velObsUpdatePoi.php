...
$newCommentInfo. $arrayDetailsAndUpdateSQL['detailObservationString']."\n";
						...
						$message = "Bonjour !<br />
Vous venez d'ajouter un commentaire à l'observation ".$arrayObs['id_poi']." sur la plateforme Cyclo-fiche et nous vous en remercions. Celui-ci devrait être administré sous peu.<br /><br />
