...
//     }
    ...
    if (isset($_GET['id_poi']) && $_GET['id_poi'] != '') {
	    ...
	    exit();
                ...
                $html .= '<p>Lien vers l\'observation sur l\'<a href="'.URL.'/index.php?id='.$poi['id_poi'].'">interface publique</a> sur l\'application VelObs </p>';
                $html .= '<p>Lien vers  l\'observation sur l\'<a href="'.URL.'/admin.php?id='.$poi['id_poi'].'">interface d\'administration</a> sur l\'application VelObs </p>';
                if ($NbreVotes > 0){
