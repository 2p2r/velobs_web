                    ...
                    while ($row = mysql_fetch_array($result)){
                        ...
                        if (mysql_num_rows($result2) > 0){
                            ...
                            while ($row2 = mysql_fetch_array($result2)){
                                $sql3 = "SELECT poi.id_poi FROM poi INNER JOIN subcategory ON (poi.subcategory_id_subcategory = subcategory.id_subcategory) WHERE subcategory.id_subcategory = ".$row2['id_subcategory']." AND poi.transmission_poi = TRUE AND poi.pole_id_pole = ".$_SESSION['pole']." AND poi.delete_poi = FALSE ";
