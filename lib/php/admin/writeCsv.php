					...
					switch ($_GET['type']) {
						...
						case 'poi':
							...
							if (!$fh) {
								...
								$result = mysql_query($sql);
								$csv = '"Identifiant";"[Public] Commentaire Vélo-Cité";"[Public] Réponse de la collectivité";"[Privé] Commentaire Vélo-Cité";"Priorité";"Pôle";"Nom adhérent";"Prénom adhérent";"Libellé observation";"Catégorie";"Sous-catégorie";"Repère";"Rue";"Commune";"Description";"Proposition";"Modération";"Affichage sur la carte";"Latitude";"Longitude";"Date création";"Mode géolocalisation";"Email";"Lien administration"';
								$csv .= "\r\n";
								while ($row = mysql_fetch_array($result)) {
