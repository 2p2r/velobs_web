					...
					switch ($_GET['type']) {
						...
						case 'poi':
							...
							if (!$fh) {
								...
								$result = mysql_query($sql);
								$csv = '"Identifiant";"Commentaire final de l\'association";"Réponse de la collectivité";"Observation terrain";"Priorité";"Pôle";"Adhérent";"Libellé enregistrement";"Catégorie";"Sous-catégorie";"Repère";"Rue";"Commune";"Description";"Proposition";"Modération";"Affichage sur la carte";"Latitude";"Longitude";"Date création";"Mode géolocalisation";"Email";"Lien administration"';
								$csv .= "\r\n";
								while ($row = mysql_fetch_array($result)) {
