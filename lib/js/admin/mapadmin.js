...
function getMarker() {
	...
	if (tabcheckchild != '') {
		...
		var uri = 'lib/php/admin/getMarker.php?listType='+tabcheckchild+'&priority='+comboPrioritePOIMapItemMenu.getValue()+'&status='+StatusPOIFieldMapItemMenu.getValue()+'&commentToModerate='+displayObservationsWithCommentToModerate;
