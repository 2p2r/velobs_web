...
function getMarker() {
	...
	if (tabcheckchild != ''  && setDefaultCenterMapDone == 1) {
		...
		xhr.send('listType='+tabcheckchild+'&dateLastModif='+dateLastModif+'&dateNotModifiedSince='+dateNotModifiedSince+'&priority='+comboPrioritePOIMapItemMenu.getValue()+'&status='+StatusPOIFieldMapItemMenu.getValue()+'&displayObservationsToBeAnalyzedByComCom='+displayObservationsToBeAnalyzedByComCom+'&displayObservationsToBeAnalyzedByPole='+displayObservationsToBeAnalyzedByPole+'&commentToModerate='+displayObservationsWithCommentToModerate+'&observationsWithoutPicture='+displayObservationsWithoutPicture+'&nbSupportMinimum='+nbSupportMinimum+'&bounds=' + bounds+'&alreadyLoadedObservations='+alreadyLoadedObservations);
		...
		xhr2.send('getCount=1&listType='+tabcheckchild+'&dateLastModif='+dateLastModif+'&dateNotModifiedSince='+dateNotModifiedSince+'&priority='+comboPrioritePOIMapItemMenu.getValue()+'&status='+StatusPOIFieldMapItemMenu.getValue()+'&displayObservationsToBeAnalyzedByComCom='+displayObservationsToBeAnalyzedByComCom+'&displayObservationsToBeAnalyzedByPole='+displayObservationsToBeAnalyzedByPole+'&commentToModerate='+displayObservationsWithCommentToModerate+'&observationsWithoutPicture='+displayObservationsWithoutPicture+'&nbSupportMinimum='+nbSupportMinimum+'&bounds=' + bounds+'&alreadyLoadedObservations='+alreadyLoadedObservations);
