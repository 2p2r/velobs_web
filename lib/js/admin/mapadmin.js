...
function getMarker() {
	...
	if (tabcheckchild != '') {
		...
		var uri = 'lib/php/admin/getMarker.php?listType='+tabcheckchild+'&dateLastModif='+dateLastModif+'&priority='+comboPrioritePOIMapItemMenu.getValue()+'&status='+StatusPOIFieldMapItemMenu.getValue()+'&displayObservationsToBeAnalyzedByComCom='+displayObservationsToBeAnalyzedByComCom+'&commentToModerate='+displayObservationsWithCommentToModerate;
