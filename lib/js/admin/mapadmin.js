	...
	if (json.markers != null) {
		for (var i=0; i<json.markers.length; i++) {
			...
			feat.attributes = {"id": json.markers[i].id,
					...
					"status":json.markers[i].lib_status,
...
function createPopup(feature) {
	...
	if (!feature.cluster){
		...
		console.log("Comments = " + featureToDisplay.attributes.comments);
		if (featureToDisplay.attributes.comments == '') {
