...
function getMarker() {
	...
	if (tabcheckchild != '') {
		...
		var uri = 'lib/php/admin/getMarker.php?listType='+tabcheckchild+'&dateLastModif='+dateLastModif+'&priority='+comboPrioritePOIMapItemMenu.getValue()+'&status='+StatusPOIFieldMapItemMenu.getValue()+'&displayObservationsToBeAnalyzedByComCom='+displayObservationsToBeAnalyzedByComCom+'&displayObservationsToBeAnalyzedByPole='+displayObservationsToBeAnalyzedByPole+'&commentToModerate='+displayObservationsWithCommentToModerate;
...
//	console.log("feature = %o", feature);
	...
	if (!feature.cluster){
		...
		emailPOIField.setValue(featureToDisplay.attributes.email);
