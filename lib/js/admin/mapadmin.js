...
function getMarker() {
	...
	if (tabcheckchild != '') {
		...
		var uri = 'lib/php/admin/getMarker.php?listType='+tabcheckchild+'&priority='+comboPrioritePOI.getValue()+'&status='+StatusPOIFieldMapItemMenu.getValue()+'&commentToModerate='+displayObservationsWithCommentToModerate;
