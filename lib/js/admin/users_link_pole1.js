...
var PoleUserLinkField = new Ext.form.ComboBox({
    id:'PoleUserLinkField',
    fieldLabel: T_pole,
    store: PoleUserList2,
...
var LinkUserPoleCreateForm = new Ext.FormPanel({
    ...
    items: [{
        ...
        items:[{
            ...
            layout: 'form',
            border: false,
            items: [ModeratorUsersField,PoleUserLinkField]
        }]
    }],
    buttons: [{
        text: T_save,
...
var LinkUserPoleCreateWindow= new Ext.Window({
    id: 'LinkUserPoleCreateWindow',
    iconCls: 'silk_user_add',
    title: T_addLinkUserPole,
    closable: false,
    border: false,
    width: 350,
    height: 220,
            ...
            success: function(response) {
                ...
                switch (Number(resultCode)) {
                    ...
                    default:
                        Ext.MessageBox.show({
                            title: T_careful,
                            msg: T_cannotDeleteSelection + res[1],
                            buttons: Ext.MessageBox.OK,
                            icon: Ext.MessageBox.ERROR
                        });
                        break;
...
function resetLinkUserPoleForm() {
	...
	PoleUserLinkField.setValue('');
}

function isLinkUserPoleFormValid() {
    return(PoleUserLinkField.isValid() && ModeratorUsersField.isValid() );
}
	...
	if (isLinkUserPoleFormValid()) {
        ...
        Ext.Ajax.request({
            ...
            params: {
                ...
                num_pole: PoleUserLinkField.getValue(),
            ...
            success: function(response) {
                ...
                switch (Number(res[0])) {
                    ...
                    case 2:
                        Ext.MessageBox.show({
                            title: T_pb,
                            msg: T_addedLinkUserPoleFailed + res[1],
                            buttons: Ext.MessageBox.OK,
                            icon: Ext.MessageBox.INFO
                        });
                        break;
