...
var arrayComponentsToDisable = ["SubCategoryPOIField", "CommunePOIField", "PolePOIField", "RespComcomPOIField", "DescPOIField", "PropPOIField", "RuePOIField", "ObsPOIField", "NumPOIField", "PrioritePOIField"];
...
var expandWindow = new Ext.Window({
    ...
    bbar : {
        ...
        items : [
            new Ext.Toolbar({
                height: 25,
                items : ['Rue:',RuePOIField,'Repère:',NumPOIField,'Priorité:',PrioritePOIField,'(POI3) Observation terrain:',ObsPOIField]
            }),
            new Ext.Toolbar({
                height: 75,
            ...
            new Ext.Toolbar({
                height: 75,
                items : ['(POI3) Réponse de la collectivité:',RespComcomPOIField,'(POI3) Réponse du pôle:',RespPolePOIField]
            }),
            new Ext.Toolbar({
                height: 25,
