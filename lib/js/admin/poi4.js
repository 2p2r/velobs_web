...
var expandWindow = new Ext.Window({
    ...
    bbar : {
        ...
        items : [
            ...
            new Ext.Toolbar({
                height: 75,
                items : ['[Public] Réponse de la collectivité:',RespComcomPOIField,'[Privé] Réponse de la collectivité:',RespPolePOIField,'[Public]<br/> ' + T_commentFinal + ':',CommentFinalPOIField]
            }),
            new Ext.Toolbar({
                height: 25,
