...
var expandWindow = new Ext.Window({
    ...
    bbar : {
        ...
        items : [
            new Ext.Toolbar({
                height: 25,
                items : ['Rue:',RuePOIField,'Repère:',NumPOIField,'Priorité:',PrioritePOIField,'(POI4) Observation terrain:',ObsPOIField]
            }),
            new Ext.Toolbar({
                height: 75,
            ...
            new Ext.Toolbar({
                height: 75,
                items : ['(POI4) Réponse de la collectivité:',RespComcomPOIField,'(POI4) Réponse du pôle:',RespPolePOIField,'(POI4) Commentaire final:',CommentFinalPOIField]
            }),
            new Ext.Toolbar({
                height: 25,
