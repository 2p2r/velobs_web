...
var arrayComponentsToDisable = ["SubCategoryPOIField", "DescPOIField", "PropPOIField", "RuePOIField", "ObsPOIField", "NumPOIField","PrioritePOIField"];
...
var expandWindow = new Ext.Window({
    ...
    bbar : {
        ...
        items : [
            new Ext.Toolbar({
                height: 25,
                items : ['Rue:',RuePOIField,'Repère:',NumPOIField,'Priorité:',PrioritePOIField,'(POI2) Observation terrain:',ObsPOIField]
            }),
            new Ext.Toolbar({
                height: 75,
            ...
            new Ext.Toolbar({
                height: 75,
                items : ['[Public] Réponse de la collectivité:',RFespComcomPOIField,'[Privé] Réponse de la collectivité:',RespPolePOIField]
            }),
            new Ext.Toolbar({
                height: 25,
