...
var mapAdminPanel = new GeoExt.MapPanel({
	...
	tbar: new Ext.Toolbar({
		height: '20',
		cls: 'x-panel-header',
		items: ['<span style="color:#333; font-family:tahoma,arial,verdana,sans-serif; font-weight:normal">'+T_applicationName+'</span>', comboPrioritePOI,checkboxDisplayObservationsWithCommentToModerate,'->', previous, '  ', '  ', next, /*' ', '  ', panButton, '  ', ' ', zoomboxButton, ' ', ' ', ' ', ' ', ' ', */' ', ' ', /*checkhillshading, ' ', geoNameSearchCombo,*/comboALL]
	})
});
