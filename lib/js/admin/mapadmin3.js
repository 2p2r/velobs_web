...
function createPopup(feature) {
    ...
    idPoiResponse = featureToDisplay.attributes.reppole;
    ...
    if (featureToDisplay.attributes.traite == null || featureToDisplay.attributes.traite == 0) {
        traiteBool = 0;
        htmlGeneral += '<br/><br/><b>'+T_traiteparpole+' :</b>&nbsp;Non';
    } else if (featureToDisplay.attributes.traite == 1) {
        traiteBool = 1;
        htmlGeneral += '<br/><br/><b>'+T_traiteparpole+' :</b>&nbsp;Oui';
    }

    if (featureToDisplay.attributes.reppole != '') {
        htmlGeneral += '<br/><br/><b>'+T_reponsePole+' : </b><br/>'+featureToDisplay.attributes.reppole+'<br/><br/><div style="width:100%;"><button onclick="openWindowPole()">'+T_editRecord+'</button><a href="'+window.location.href.substring(0, window.location.href.lastIndexOf('/'))+'/admin.php?id='+featureToDisplay.attributes.id+'"><img src="./resources/icon/silk/script_save.png" style="float:right;" /></a></div>';
    } else {
        htmlGeneral += '<br/><br/><div style="width:100%;"><button onclick="openWindowPole()">'+T_addReponsePole+'</button><a href="'+window.location.href.substring(0, window.location.href.lastIndexOf('/'))+'/admin.php?id='+featureToDisplay.attributes.id+'"><img src="./resources/icon/silk/script_save.png" style="float:right;" /></a></div>';
    }
	}else{
...
var mapAdminPanel = new GeoExt.MapPanel({
    ...
    tbar: new Ext.Toolbar({
        height: '20',
        cls: 'x-panel-header',
        items: ['<span style="color:#333; font-family:tahoma,arial,verdana,sans-serif; font-weight:normal">'+T_applicationName+'</span>',searchObservationField,searchObservationButton, '->', comboALL]
    })
});
