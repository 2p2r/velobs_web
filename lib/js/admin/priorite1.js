...
var PrioritesColumnModel = new Ext.grid.ColumnModel(
	[identifiantPriorite, { 
		...
		},mailSubject,mailBody,needFinalCommentCheckbox,visibilityPublicCheckbox,visibilityCollectivityCheckbox,visibilityPublicDefaultCheckbox]
);
...
var PrioriteListingEditorGrid = new Ext.grid.EditorGridPanel({
	...
	plugins: [needFinalCommentCheckbox, visibilityPublicCheckbox, visibilityCollectivityCheckbox,visibilityPublicDefaultCheckbox],
	clicksToEdit: 2,
