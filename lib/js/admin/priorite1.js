...
var PrioritesColumnModel = new Ext.grid.ColumnModel(
	[identifiantPriorite, { 
		...
		},mailSubject,mailBody,visibilityPublicCheckbox,visibilityCollectivityCheckbox,needFinalCommentCheckbox]
);
...
var PrioriteListingEditorGrid = new Ext.grid.EditorGridPanel({
	...
	plugins: [needFinalCommentCheckbox, visibilityPublicCheckbox, visibilityCollectivityCheckbox],
