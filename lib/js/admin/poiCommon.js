...
function displayMarkerAndCenter(response) {
    ...
    if (json.markers != null) {
        ...
        if (json.markers[i]['commentaires']!=null) {
            ...
            createFeaturePublicMapAndOpen(id,lonlat.lon,lonlat.lat, json.markers[0].icon, json.markers[0].lib_subcategory, json.markers[0].lib_status, json.markers[0].desc, json.markers[0].prop, json.markers[0].iconCls, json.markers[0].id, json.markers[0].photo, json.markers[0].num, json.markers[0].rue, json.markers[0].commune, json.markers[0].repgt, json.markers[0].cmt, json.markers[0].date, json.markers[0].lastdatemodif_poi, comments,json.markers[0].mail_poi);
        } else {
            createFeaturePublicMapAndOpen(id,lonlat.lon,lonlat.lat, json.markers[0].icon, json.markers[0].lib_subcategory, json.markers[0].lib_status, json.markers[0].desc, json.markers[0].prop, json.markers[0].iconCls, json.markers[0].id, json.markers[0].photo, json.markers[0].num, json.markers[0].rue, json.markers[0].commune, json.markers[0].repgt, json.markers[0].cmt, json.markers[0].date, json.markers[0].lastdatemodif_poi, null, json.markers[0].mail_poi);
        }
    }else{
