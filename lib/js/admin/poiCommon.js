...
var communePOIList = new Ext.data.JsonStore({
	...
	comboPrioritePOI.on('afterrender', function(){
		  Ext.QuickTips.register({ target: comboPrioritePOI.getEl(), text: 'N\'afficher que les observations avec la prorité (donnée par le modérateur de l\'association) - se cumule avec les autres filtres.' });
		});
