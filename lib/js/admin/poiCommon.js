		...
		var moderationInterfaceWindow = new Ext.Window({
		    ...
		    tbar : {
		        ...
		        items : [new Ext.Toolbar({
		                height: 25,
		                items : ['Rue:',RuePOIField,'Commune:',CommunePOIField,'Repère:',NumPOIField,'->',buttonPhotoPOI, '-',buttonModerateComments,commentAddButtonForModerationWindow]
		            })]
		    },
		    bbar : {
		        xtype : 'container',
		        ...
		        items : [
		            new Ext.Toolbar({
		                height: 25,
		                items : ['Priorité:',PrioritePOIField,'Catégorie:',SubCategoryPOIField]
		            }),
		            new Ext.Toolbar({
		                height: 75,
		            ...
		            new Ext.Toolbar({
		                height: 25,
		                items : ['Pole:',PolePOIField,'Statut:',StatusPOIField]
		            }),
		            new Ext.Toolbar({
		                height: 25,
		                items : ['Modération :', ModerationPOIField, ' | Affichage :', DisplayPOIField,' | Transmission au pole', TransmissionPolePOIField,' | Traité par pole:',TraitePolePOIField,'->', emailPOIField,sendMailButton,' ',historyButtonForModerationWindow,printButtonForModerationWindow,' ',validButton, ' ', resetButton]
		            })
		        ]
		    }
		});
