		...
		var moderationInterfaceWindow = new Ext.Window({
		    ...
		    bbar : {
		        ...
		        items : [
		            ...
		            new Ext.Toolbar({
		                height: 25,
		                items : ['Lat :', latitudeField, ' ', 'Long :', longitudeField,' ', 'Modération :', ModerationPOIField, 'Affichage :', DisplayPOIField,'Traité par pole:',TraitePolePOIField,'Transmission au pole', TransmissionPolePOIField,'->', emailPOIField,sendMailButton,' ',printButtonForModerationWindow,' ',validButton, ' ', resetButton]
		            })
		        ]
		    }
		});
