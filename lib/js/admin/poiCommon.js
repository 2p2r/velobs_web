		...
		var moderationInterfaceWindow = new Ext.Window({
		    ...
		    tbar : {
		        ...
		        items : [new Ext.Toolbar({
		                height: 25,
		                items : ['Rue:',RuePOIField,'Commune:',CommunePOIField,'Repère:',NumPOIField,'->',buttonPhotoPOI, '-',buttonModerateComments]
		            })]
		    },
		    bbar : {
		        xtype : 'container',
		        ...
		        items : [
		            ...
		            new Ext.Toolbar({
		                height: 25,
		                items : ['Modération :', ModerationPOIField, ' | Affichage :', DisplayPOIField,' | Transmission au pole', TransmissionPolePOIField,' | Traité par pole:',TraitePolePOIField,'->', emailPOIField,sendMailButton,' ',printButtonForModerationWindow,' ',validButton, ' ', resetButton]
		            })
		        ]
		    }
		});
