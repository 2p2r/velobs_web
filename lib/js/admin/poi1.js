...
var expandWindow = new Ext.Window({
    ...
    bbar : {
        ...
        items : [
            new Ext.Toolbar({
                height: 25,
                items : ['Rue:',RuePOIField,'Repère:',NumPOIField,'Priorité:',PrioritePOIField,' (POI1) Observation terrain:',ObsPOIField]
            }),
            new Ext.Toolbar({
                height: 75,
            ...
            new Ext.Toolbar({
                height: 75,
                items : ['(POI1) Réponse de la collectivité:',RespComcomPOIField,'(POI1) Réponse du pôle:',RespPolePOIField,'(POI1) Commentaire final:',CommentFinalPOIField]
            }),
            new Ext.Toolbar({
                height: 25,
