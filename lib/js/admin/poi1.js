...
var arrayComponentsToDisable = ["RespPolePOIField","RespComcomPOIField"];
...
function createFeature(X,Y,com,pole,status,reponsecomcom,reponsepole,desc,prop,subcat,rue,num,obs,comment,modo,disp,ref) {
...
moderatePOIButton.on('click', function(columnIndex, grid, rowIndex, e) {
	...
	if ((lat == '') && (lon == '')) {
        ...
        createFeature(lonlat.lon,lonlat.lat,commune,pole,status,reponsecomcom,reponsepole,desc,prop,subcat,rue,num,obs,comment,modo,disp,ref);
