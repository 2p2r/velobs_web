...
var arrayItemsMenuAdminMap = ['<span style="color:#333; font-family:tahoma,arial,verdana,sans-serif; font-weight:normal">'+T_applicationName+'</span>', StatusPOIFieldMapItemMenu,comboPrioritePOI,checkboxDisplayObservationsWithCommentToModerate, ' ',searchObservationField,searchObservationButton,'->', previous, '  ', '  ', next, comboALL];
