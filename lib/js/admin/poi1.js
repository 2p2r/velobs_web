//composants devant être inaccessibles au compte administrateur dans l'interface de moderation d'une observation
...
var arrayItemsMenuAdminMap = ['<span style="color:#333; font-family:tahoma,arial,verdana,sans-serif; font-weight:normal">'+T_applicationName+'</span>', StatusPOIFieldMapItemMenu,comboPrioritePOIMapItemMenu,checkboxDisplayObservationsWithCommentToModerate, ' ',searchObservationField,searchObservationButton,'->', previous, '  ', '  ', next, comboALL];
