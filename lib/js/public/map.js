...
//      }
        ...
        console.log("STATUT = " + json.markers[i].lib_status);
...
var layerLimitesGeographiquesCommunes = new OpenLayers.Layer.Vector("Limites communes", {reportError:true,styleMap:styleCommune, visibility: false, displayInLayerSwitcher: true,eventListeners:{
	 "featureadded": function(feature) {
		   console.log(feature);
		  }
		}});
layerLimitesGeographiquesCommunes.setZIndex(5);
var layerLimitesGeographiquesPoles = new OpenLayers.Layer.Vector("Limites poles", {reportError:true,styleMap:stylePole, visibility: false, displayInLayerSwitcher: true,eventListeners:{
	 "featureadded": function(feature) {
		   console.log(feature);
		  }
		}});
