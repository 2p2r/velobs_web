...
//	console.log("feature = %o", feature);
	...
	if (!feature.cluster){
		...
		htmlGeneral += '<br/><div style="width:100%;"><button type="button" onclick="addComment()">Ajouter un commentaire</button> <button type="button" onclick="addSupport()">'+T_addVote+'</button><a href="'+window.location.href.substring(0, window.location.href.lastIndexOf('/'))+'/admin.php?id='+featureToDisplay.attributes.id+'"><img src="./resources/icon/silk/script_save.png" style="float:right;" /></a></div>';
...
var CustomPolygonField = new Ext.form.TextArea({
	...
	fieldLabel: T_custom_polygone,//TODO
	maxLength: 500,
	allowBlank: false,
	height: 100,
	anchor : '99%'
});
var eastPanelFormExportPOI = new Ext.form.FormPanel({
	id: 'eastPanelFormExportPOI',
	hidden: true,
	baseCls: 'x-plain',
	region: 'east',
	header: false,
	...
	items: [{
		...
		collapsible: false,
		title: T_obs,
		items: [CommunePOIField, TerritoireField, CustomPolygonField]
	}
	],
	buttonAlign: 'center',
	buttons: [{
		...
		handler: function() {
			treePanel.expand();
			eastPanelFormExportPOI.collapse();
			participationButton.toggle();
			participationButton.enable();
			resetPOIForm();
			feat.destroy();
...
//			
//			
//		eastPanelFormExportPOI.getForm().submit({
//			waitMsg: T_pleaseWait,
//			url: 'lib/php/admin/database.php',
//			params: {
//				task: "EXPORTPUBLICPOI",
//				commune_poi: CommunePOIField.getValue(),
//				territoire_poi: TerritoireField.getValue(), 
//				customPolygon_poi: CustomPolygonField.getValue()
//			},
//			success: function(eastPanelFormExportPOI, o) {
//				console.log("eastPanelFormExportPOI success "+o.result.ok);
//				Ext.MessageBox.show({
//					title: T_propSent,
//					msg: o.result.ok,
//					buttons: Ext.Msg.OK,
...
//					iconCls: 'silk_tick'
//				});
//				Ext.getCmp('eastPanelFormExportPOI').collapse();
//				treePanel.expand();
//				participationButton.toggle();
//				participationButton.enable();
//				resetPOIForm();//TODO
...
////				feat = null;
//			},
//			failure: function(eastPanelFormExportPOI, o) {
//				console.log("eastPanelFormExportPOI echec "+o.result.pb);
//				Ext.MessageBox.show({
//					title: T_transfertKO,//TODO
//					msg: o.result.pb,
//					buttons: Ext.Msg.OK,
//					icon: Ext.MessageBox.ERROR,
//					iconCls: 'fugue_cross-script'
