...
var mapGeoExtPanel = new GeoExt.MapPanel({
	...
	tbar: new Ext.Toolbar({
		height: '20',
		cls: 'x-panel-header',
		items: [dateFieldModifiedSince, ' ',StatusPOIFieldMapItemMenu, '&nbsp;',comboPrioritePOIMapItemMenu, ' ', checkBoxdisplayLayerLimitesGeographiquesCommunes,' ',checkBoxDisplaylayerLimitesGeographiquesPoles, ' ',searchObservationField,searchObservationButton,'->' ,comboboxSelectMapLayer]
	})
});
