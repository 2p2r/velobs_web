...
function showTooltip(event){ 
	...
	console.log("my object: %o", event.X)
	//Display Tooltip 
	tooltip = new Ext.ToolTip({ 
		html: 'Observation n° ' + feature.attributes.id, 
		dismissDelay: 3000 
	}); 
...
var mapGeoExtPanel = new GeoExt.MapPanel({
	...
	tbar: new Ext.Toolbar({
		height: '20',
		cls: 'x-panel-header',
		items: [comboboxFilterObservationsByDate, ' ',comboboxFilterObservationsByStatus, '&nbsp;',checkboxDisplayObservationsCloturees, ' ', checkBoxdisplayLayerLimitesGeographiquesCommunes,' ',checkBoxDisplaylayerLimitesGeographiquesPoles, '->' ,comboboxSelectMapLayer]
	})
});
