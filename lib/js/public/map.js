...
function getMarker() {
	...
	if (tabcheckchild != '') {
		...
		var uri = 'lib/php/public/getMarker.php?listType='+tabcheckchild+'&dateLastModif='+dateLastModif+'&status='+status+'&priorite='+comboPrioritePOIMapItemMenu.getValue()+'&nbSupportMinimum='+nbSupportMinimum;
...
var mapGeoExtPanel = new GeoExt.MapPanel({
	...
	tbar: new Ext.Toolbar({
		height: '20',
		cls: 'x-panel-header',
		items: [dateFieldModifiedSince,CancelDateFilterItem,'&',StatusPOIFieldMapItemMenu,CancelStatusFilterItem, '&nbsp;',comboPrioritePOIMapItemMenu,CancelPrioriteFilterItem,' ', numberFieldNbSupport]
	}),
