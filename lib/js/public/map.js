...
function getMarker() {
	//clearMarker();
	console.log("setDefaultCenterMapDone = "+setDefaultCenterMapDone)
	...
	if (tabcheckchild != '' && setDefaultCenterMapDone == 1) {
		...
		console.log(publicMap.getExtent().transform(projection1, projection2).toGeometry().toString());//transform
