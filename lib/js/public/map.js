...
function createFeaturePublicMapAndOpen(id,X,Y,icon,lib_subcategory,desc,prop,iconCls,id,photo,num,rue,commune,repgt,cmt,date,lastDateModif,comments) {
    ...
    feat.attributes = {"id": id, "lib_subcategory": lib_subcategory, "desc": desc, "prop": prop, "iconCls": iconCls, "photo": photo, "num": num, "rue": rue, "commune": commune, "repgt": repgt, "cmt": cmt, "date": date, "lastDateModif":lastDateModif, "comments": comments, "icon":icon};
