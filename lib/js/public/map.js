...
function getMarker() {
	...
	if (tabcheckchild != '') {
		...
		var uri = 'lib/php/public/getMarker.php?listType='+tabcheckchild+'&dateLastModif='+dateLastModif+'&status='+StatusPOIFieldMapItemMenu.getValue()+'&priorite='+comboPrioritePOIMapItemMenu.getValue();
...
var mapGeoExtPanel = new GeoExt.MapPanel({
	...
	tbar: new Ext.Toolbar({
		height: '20',
		cls: 'x-panel-header',
		items: [dateFieldModifiedSince, CancelDateFilterItem, '&nbsp;',StatusPOIFieldMapItemMenu, CancelStatusFilterItem, '&nbsp;',comboPrioritePOIMapItemMenu, CancelPrioriteFilterItem, '&nbsp;', checkBoxdisplayLayerLimitesGeographiquesCommunes,' ',checkBoxDisplaylayerLimitesGeographiquesPoles, ' ',searchObservationField,searchObservationButton,'->' ,comboboxSelectMapLayer]
	})
});
