...
Ext.onReady(function(){
			...
			afterrender: function() {
					statStore.load({
					    callback: function () {
							...
							var nouveauContenu = document.createTextNode("Statut des observations créées sur le territoire couvert par " + T_applicationName);
	...
	viewport = new Ext.Viewport({
		layout: 'border',
		title: 'VelObs [Carto]',
		items: [headerPanel,mapPanel,southPanelFormExportPOI,eastPanelFormCreatePOI],
		listeners: {
